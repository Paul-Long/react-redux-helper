...
var _effects = require('redux-saga/lib/effects');
...
function getWatcher(_ref) {
  ...
  if (Array.isArray(_effect)) {
    var _effect2 = (0, _slicedToArray3.default)(_effect, 2),
        e = _effect2[0],
        opts = _effect2[1];
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return effect.apply(undefined, _args4);
  ...
  var action = (0, _prefixType2.default)(key, model);
